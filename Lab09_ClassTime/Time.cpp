...
Time::ExTime::ExTime(int v, string t)
{
	ExTime::val = v;
	ExTime::er = t;
}
...
Time::Time(int h, int m, int s)
{
	if (s >= 60)
	{
		string mes = "Неправильное значение в секундах!";
		throw ExTime::ExTime(s, mes);
	}
	if (m >= 60)
	{
		string mes = "Неправильное значение в минутах!";
		throw ExTime::ExTime(m, mes);
	}
